...
<div class="card card-outline card-success mt-2">
    ...
    <div class="card-body">
        <form action="{{route('cotizaciones.store')}}" method="POST" id="form_cotizacion">
        @csrf
        <div class="row">
            <div class="col-sm-4">
                <label for="">Fecha <span>*</span></label>
                <input type="datetime-local" class="form-control" name="fecha_cotizacion" id="fecha_cotizacion" value="{{$dt}}" required>
            </div>
            <div class="col-sm-4">
                                ...
                                <table class="display responsive nowra" width="100%" style="border: 1px;" id="myTable">
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th style="text-align: center"><span class="total"> </span>
                                            </th>
                                            <th></th>
                                        </tr>
                                    </tfoot>                        

    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'can'       =>  'compra_productos.index',
            'submenu'   =>  [
                        [
                            'text'  =>  'Listar Compras',
                            'url'   =>  'compra_productos',
                            'icon'  =>  'fas fa-shopping-bag',
                            'can'   =>  'compra_productos.index',
                        ],
                        [
                            'text'  =>  'Crear Compra',
                            'url'   =>  'compra_productos/create',
                            'icon'  =>  'fas fa-square',
                            'can'   =>  'compra_productos.create',
                        ],
                    ],
        ],
        [
        ...
        [
            ...
            'submenu'      => [
                        ...
                        [
                            ...
                            'url'       =>  'grupo_clientes',
                            'icon'      =>  'fas fa-folder fa-fw',
                            'can'       =>  'grupo_clientes.index',
                        ],
                        [
                            'text'      =>  'Admin Proveedores',
                            'url'       =>  'proveedores',
                            'icon'      =>  'fas fa-folder fa-fw',
